...
switchD_00439434_default:
  ...
  *(undefined1 *)city = 1;
  ...
  if (city->safety_score < 1) {
    ...
    local_c1 = uVar2 < (ushort)((sVar3 + 1) * 0x1e);
    if (!local_c1) {
      if (_DAT_00748e34 == g_human_country_index) {
        if (DAT_0074a2cc != '\x01') {
          return false;
        ...
        FUN_00503730(local_c0,&DAT_00519448,g_active_country->name_bytes,&DAT_007350bc + iVar4,
                     &DAT_005a7bdc + (uint)city->city_type_or_terrain_class * 5,&city->field_0x3);
      }
  ...
  if (_DAT_00748e34 == g_human_country_index) {
    ...
    if ((char)city->field_0x1 == g_human_country_index) {
      ...
      sVar3 = FUN_004fbf50(2);
      if (sVar3 != 0) {
        FUN_00503730(local_c0,&DAT_0051950c,
                     &DAT_005a7bdc + (uint)city->city_type_or_terrain_class * 5,&city->field_0x3,
                     g_active_country->name_bytes);
        goto LAB_0043969c;
      }
