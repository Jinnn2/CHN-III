...
public class GhidraSemanticAnnotate extends GhidraScript {
    ...
    private void renameFunctions() {
        Rename[] renames = new Rename[] {
            ...
            new Rename(0x41fd60L, "Main_WindowProc"),
            new Rename(0x420350L, "Create_Main_Window"),
            new Rename(0x4204b0L, "Init_Working_Directories"),
            ...
            new Rename(0x5028b0L, "Input_On_KeyUp"),
            new Rename(0x502a00L, "Input_Reset_Keyboard_State"),
            new Rename(0x502a40L, "Input_Is_KeyDownOrModifier"),
            new Rename(0x502b00L, "Input_Pop_KeyEvent_candidate"),
            new Rename(0x502b60L, "Input_Release_IME_Resources_candidate"),
            new Rename(0x502bc0L, "Input_Create_IME_Context_candidate"),
            new Rename(0x502bf0L, "Input_Reassociate_IME_Context_candidate"),
            new Rename(0x502c70L, "Input_On_InputLangChange_candidate"),
            new Rename(0x502fd0L, "IME_On_Composition_candidate"),
            new Rename(0x503360L, "Input_On_MouseButtonDown"),
            new Rename(0x5033f0L, "Input_On_MouseButtonUp"),
            new Rename(0x503480L, "Input_On_MouseMove"),
            new Rename(0x503710L, "Input_Set_MouseCapture"),
    ...
    private void renameGlobals() throws Exception {
        GlobalRename[] globals = new GlobalRename[] {
            ...
            new GlobalRename(0x00589374L, "g_hex_neighbor_delta_x_by_parity", new ArrayDataType(IntegerDataType.dataType, 16, 4)),
            new GlobalRename(0x005893b4L, "g_hex_neighbor_delta_y_by_parity", new ArrayDataType(IntegerDataType.dataType, 16, 4)),
            new GlobalRename(0x00589644L, "g_battle_feature_values", new ArrayDataType(IntegerDataType.dataType, 16, 4)),
            ...
            new GlobalRename(0x005dff9cL, "g_frame_one_second_elapsed", IntegerDataType.dataType),
            new GlobalRename(0x005dffa0L, "g_frame_elapsed_ms_accum", IntegerDataType.dataType),
            new GlobalRename(0x005dffa4L, "g_frame_count_this_second", IntegerDataType.dataType),
            new GlobalRename(0x005dffa8L, "g_frame_count_last_second", IntegerDataType.dataType),
            ...
            new GlobalRename(0x00716758L, "g_science_editor_selected_science_id", IntegerDataType.dataType),
            new GlobalRename(0x00706eb8L, "g_science_editor_selected_country", new PointerDataType(country, dtm)),
            new GlobalRename(0x00706eccL, "g_science_priority_target_backup", new ArrayDataType(IntegerDataType.dataType, 12, 4)),
            new GlobalRename(0x00706efcL, "g_science_editor_status_panel_enabled", IntegerDataType.dataType),
            new GlobalRename(0x00706f00L, "g_science_editor_selected_status_editable", IntegerDataType.dataType),
            new GlobalRename(0x00706f04L, "g_science_editor_prerequisites_met", IntegerDataType.dataType),
            new GlobalRename(0x00706f08L, "g_science_editor_prerequisites_missing", IntegerDataType.dataType),
            new GlobalRename(0x00706f0cL, "g_science_editor_selected_status_unstarted", IntegerDataType.dataType),
            new GlobalRename(0x00706f10L, "g_science_editor_apply_status_change_enabled", IntegerDataType.dataType),
            ...
            new GlobalRename(0x00706cd4L, "g_flag_editor_red_level", IntegerDataType.dataType),
            new GlobalRename(0x00706cdcL, "g_flag_editor_green_level", IntegerDataType.dataType),
            new GlobalRename(0x00706cd8L, "g_flag_editor_blue_level", IntegerDataType.dataType),
            new GlobalRename(0x00572094L, "g_flag_editor_pixel_write_blocked", IntegerDataType.dataType),
            new GlobalRename(0x00572098L, "g_flag_editor_pixel_x", IntegerDataType.dataType),
            new GlobalRename(0x0057209cL, "g_flag_editor_pixel_y", IntegerDataType.dataType),
            ...
            new GlobalRename(0x00748f2eL, "g_input_current_key_word", UnsignedShortDataType.dataType),
            new GlobalRename(0x00589408L, "g_input_direction_current", IntegerDataType.dataType),
            new GlobalRename(0x0057f25cL, "g_input_direction_last", IntegerDataType.dataType),
            new GlobalRename(0x005c7810L, "g_map_bookmark_tile_x_slots", IntegerDataType.dataType),
            new GlobalRename(0x005c7814L, "g_map_bookmark_tile_y_slots", IntegerDataType.dataType),
            new GlobalRename(0x005c7818L, "g_map_bookmark_unknown_slots", IntegerDataType.dataType),
            ...
            new GlobalRename(0x00714a18L, "g_custom_map_selectable_country_ids", new ArrayDataType(IntegerDataType.dataType, 100, 4)),
            new GlobalRename(0x00714bb0L, "g_custom_map_country_setup_mode", IntegerDataType.dataType),
            new GlobalRename(0x00706cc8L, "g_custom_map_existing_country_setup_flag", ByteDataType.dataType),
            new GlobalRename(0x00707f94L, "g_custom_map_loaded_country_state_flag", ByteDataType.dataType),
            new GlobalRename(0x00708218L, "g_custom_map_empire_country_defs_backup", new ArrayDataType(IntegerDataType.dataType, 0x3200, 4)),
            new GlobalRename(0x0074d520L, "g_country_portrait_image_bank_slots", new PointerDataType(VoidDataType.dataType, dtm)),
            new GlobalRename(0x0074d660L, "g_edit_country_portrait_image_bank_slots", new PointerDataType(VoidDataType.dataType, dtm)),
            new GlobalRename(0x00708088L, "g_country_portrait_preview_handles", IntegerDataType.dataType),
            new GlobalRename(0x0070808cL, "g_edit_country_portrait_preview_handles", IntegerDataType.dataType),
            new GlobalRename(0x00755950L, "g_scripted_start_mode_enabled", IntegerDataType.dataType),
            new GlobalRename(0x00755940L, "g_commandline_demo_mode_enabled", IntegerDataType.dataType),
            new GlobalRename(0x00755968L, "g_commandline_load_exception_flag", IntegerDataType.dataType),
            new GlobalRename(0x005715b0L, "g_empire_country_edit_file_slot", IntegerDataType.dataType),
            new GlobalRename(0x005715b4L, "g_empire_country_edit_file_slot_backup", IntegerDataType.dataType),
            new GlobalRename(0x005715b8L, "g_country_profile_edit_file_slot", IntegerDataType.dataType),
            new GlobalRename(0x005715bcL, "g_country_profile_edit_file_slot_backup", IntegerDataType.dataType),
            new GlobalRename(0x00706b0cL, "g_empire_country_editor_selected_index", IntegerDataType.dataType),
            new GlobalRename(0x00706b10L, "g_empire_country_editor_list_limit", IntegerDataType.dataType),
            new GlobalRename(0x00706b14L, "g_empire_country_editor_visible_count", IntegerDataType.dataType),
            new GlobalRename(0x00706b18L, "g_empire_country_editor_scrollbar", new PointerDataType(IntegerDataType.dataType, dtm)),
            new GlobalRename(0x00706b20L, "g_empire_country_defs_edit_backup", new PointerDataType(IntegerDataType.dataType, dtm)),
            new GlobalRename(0x00706b24L, "g_empire_country_editor_scroll_offset", IntegerDataType.dataType),
            new GlobalRename(0x00706b28L, "g_empire_country_default_file_exists", ByteDataType.dataType),
            new GlobalRename(0x00706e88L, "g_country_profile_editor_selected_index", IntegerDataType.dataType),
            new GlobalRename(0x00706e84L, "g_country_profile_editor_visible_count", IntegerDataType.dataType),
            new GlobalRename(0x00706e8cL, "g_country_profile_editor_scrollbar", new PointerDataType(IntegerDataType.dataType, dtm)),
            new GlobalRename(0x00706e90L, "g_country_profile_defs_edit_backup", new PointerDataType(IntegerDataType.dataType, dtm)),
            new GlobalRename(0x00706e94L, "g_country_profile_editor_list_limit", IntegerDataType.dataType),
            new GlobalRename(0x00706e98L, "g_country_profile_editor_scroll_offset", IntegerDataType.dataType),
            new GlobalRename(0x00706e9cL, "g_country_profile_editor_portrait_preview", new PointerDataType(VoidDataType.dataType, dtm)),
            new GlobalRename(0x00706ea0L, "g_country_profile_default_file_exists", ByteDataType.dataType),
            new GlobalRename(0x00572580L, "g_country_profile_preview_image_mode", IntegerDataType.dataType),
            new GlobalRename(0x00572584L, "g_country_profile_preview_resource_id", IntegerDataType.dataType),
            new GlobalRename(0x00572588L, "g_country_profile_preview_image_bank", IntegerDataType.dataType),
            ...
            new GlobalRename(0x005723f0L, "g_ground_editor_selected_row", IntegerDataType.dataType),
            new GlobalRename(0x00706e7cL, "g_ground_defs_edit_backup", new PointerDataType(groundDef, dtm)),
            new GlobalRename(0x00706e80L, "g_ground_default_file_exists", ByteDataType.dataType),
            ...
            new GlobalRename(0x0057e988L, "g_editor_selected_battle_feature_set", IntegerDataType.dataType),
            new GlobalRename(0x007157dcL, "g_editor_battle_feature_variant_mode", IntegerDataType.dataType),
            new GlobalRename(0x0057ea88L, "g_editor_battle_feature_base_id_slots", new ArrayDataType(ByteDataType.dataType, 24, 1)),
            new GlobalRename(0x0057ea9cL, "g_editor_battle_feature_custom_base_id", ByteDataType.dataType),
