...
public class GhidraExport extends GhidraScript {
    ...
    private static final Target[] TARGETS = new Target[] {
        ...
        new Target(0x401000L, "game/ai_act_ship.c"),
        new Target(0x401d40L, "game/ai_air_oil_plane.c"),
        new Target(0x4027f0L, "game/ai_air_plane.c"),
        new Target(0x403520L, "game/ai_army.c"),
        new Target(0x404780L, "game/ai_carrier.c"),
        new Target(0x406ff0L, "game/ai_ship.c"),
        new Target(0x4086e0L, "game/newland_name.c"),
        new Target(0x408ec0L, "game/ai_transport.c"),
        new Target(0x4094b0L, "game/ai_unclear.c"),
        new Target(0x409960L, "game/ai_worker.c"),
        ...
        new Target(0x4c6e60L, "map/diag_coords_to_tile_x.c"),
        new Target(0x4c6e80L, "map/diag_coords_to_tile_y.c"),
        new Target(0x4c6e90L, "map/tile_to_diag_coord_a.c"),
        new Target(0x4c6eb0L, "map/tile_to_diag_coord_b.c"),
        new Target(0x4f8660L, "render/free_pixel_format_tables.c"),

        new Target(0x40b580L, "game/start_map_battle_from_army.c"),
        new Target(0x411ea0L, "game/city_capture_transfer.c"),
        new Target(0x4131f0L, "game/add_new_view.c"),
        new Target(0x413b40L, "game/del_army_view.c"),
        ...
        new Target(0x41b0f0L, "game/army_belong_change.c"),
        ...
        new Target(0x41b920L, "game/long_wall_able.c"),
        ...
        new Target(0x42b7c0L, "game/countrypoint_minus.c"),
        ...
        new Target(0x46a840L, "game/add_new_explode.c"),
        new Target(0x46ab60L, "game/find_direct.c"),
        ...
        new Target(0x4711f0L, "game/join_to.c"),
        new Target(0x471380L, "game/break_out.c"),
        new Target(0x492760L, "extra/do_country_diplomat.c"),
        new Target(0x4912e0L, "game/do_army_turn_job.c"),
        new Target(0x4939c0L, "game/clear_forest_or_resource.c"),
        new Target(0x493a30L, "game/make_new_work.c"),
        new Target(0x493be0L, "game/make_new_make.c"),
        new Target(0x494110L, "game/order_check.c"),
        new Target(0x4951e0L, "game/order_follower_useable.c"),
        new Target(0x495320L, "extra/order_diplomat_choice_mission.c"),
        new Target(0x495540L, "extra/order_spy_choice_mission.c"),
        ...
        new Target(0x495c90L, "game/order_forset.c"),
        new Target(0x496180L, "game/order_go.c"),
        new Target(0x496550L, "game/order_go_act.c"),
        new Target(0x4966e0L, "game/order_guard.c"),
        new Target(0x496bd0L, "game/order_join_sel.c"),
        new Target(0x496d40L, "game/order_join_all.c"),
        new Target(0x498950L, "game/order_nothing.c"),
        new Target(0x498f00L, "game/order_out.c"),
        new Target(0x499010L, "game/order_out_all.c"),
        new Target(0x499090L, "game/apply_orderqueue_army.c"),
        ...
        new Target(0x4b0130L, "game/add_orderqueue_army.c"),
        ...
        new Target(0x4d2cc0L, "game/test_road.c"),
